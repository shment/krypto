...
st.write("The goal is to achieve the objective by using all 5 numbers, parenthesis and the 4 basic arithmetic operations. For example:")
...
st.header("Numbers: " + numbers_to_text(st.session_state.nums))
st.header("Objective: " + str(int(st.session_state.objective)))
